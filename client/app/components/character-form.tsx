...
import { seriesApi, type Series, type Book, type Character } from "@/lib/api";
...
interface CharacterFormProps {
  /** Initial values for editing an existing character */
  initialData?: Partial<Character> & { bookIds?: string[] };
...
export function CharacterForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!name?.trim()) {
      setInternalError("Character name is required");
      return;
    }
